...
add: '添加',
  ...
  settings: {
    ...
    readonly: '只读',
    trustedProxies: '信任的代理',
    trustedProxiesPlaceholder: '每行一个 IP 或 CIDR，例如：\n173.245.48.0/20\n103.21.244.0/22',
    trustedProxiesHint: '配置反向代理 IP，系统将信任来自这些 IP 的 X-Forwarded-For 头',
    cloudflarePreset: 'Cloudflare 预设',
    // GeoIP 设置
    geoipConfig: 'GeoIP 地理定位',
    geoipEnabled: '已启用',
    geoipDisabled: '未启用',
    geoipPath: '数据库路径',
    geoipUpload: '上传数据库',
    geoipUploading: '上传中...',
    geoipDelete: '删除',
    geoipDeleteConfirm: '确定要删除 GeoIP 数据库吗？删除后审计日志将不再记录地理位置信息。',
    geoipDeleteTitle: '删除 GeoIP 数据库',
    geoipUploadSuccess: 'GeoIP 数据库已上传并启用',
    geoipUploadFailed: '上传失败',
    geoipDeleteSuccess: 'GeoIP 数据库已删除',
    geoipDeleteFailed: '删除失败',
    geoipHint: '上传 MaxMind GeoIP2/GeoLite2 City 数据库（.mmdb 格式）以启用 IP 地理位置记录',
